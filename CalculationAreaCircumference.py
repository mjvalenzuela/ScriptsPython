...
# Creacion y configuracion de la ventanad
ventana = tkinter.Tk()
ventana.title("Mi nombre es Johanna Valenzuela")
...
# Creación del texto que mostrará el agradecimiento
caja_regrads = tkinter.Label(ventana, text="Gracias Ronald y equipo HelpGIS")
caja_regrads.pack()
